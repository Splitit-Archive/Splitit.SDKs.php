...
class InstallmentPlanApi
{
    ...
    /**
     * Operation installmentPlanCreatePublicToken
     *
     * @param  \SplititSdkClient\Model\PublicTokenRequest $request request (required)
     *
     * @throws \SplititSdkClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplititSdkClient\Model\PublicTokenResponse
     */
    public function installmentPlanCreatePublicToken($request)
    {
        list($response) = $this->installmentPlanCreatePublicTokenWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation installmentPlanCreatePublicTokenWithHttpInfo
     *
     * @param  \SplititSdkClient\Model\PublicTokenRequest $request (required)
     *
     * @throws \SplititSdkClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplititSdkClient\Model\PublicTokenResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function installmentPlanCreatePublicTokenWithHttpInfo($request)
    {
        $returnType = '\SplititSdkClient\Model\PublicTokenResponse';
        $request = $this->installmentPlanCreatePublicTokenRequest($request);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SplititSdkClient\Model\PublicTokenResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation installmentPlanCreatePublicTokenAsync
     *
     * 
     *
     * @param  \SplititSdkClient\Model\PublicTokenRequest $request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function installmentPlanCreatePublicTokenAsync($request)
    {
        return $this->installmentPlanCreatePublicTokenAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation installmentPlanCreatePublicTokenAsyncWithHttpInfo
     *
     * 
     *
     * @param  \SplititSdkClient\Model\PublicTokenRequest $request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function installmentPlanCreatePublicTokenAsyncWithHttpInfo($request)
    {
        $returnType = '\SplititSdkClient\Model\PublicTokenResponse';
        $request = $this->installmentPlanCreatePublicTokenRequest($request);
    ...
    /**
     * Create request for operation 'installmentPlanCreatePublicToken'
     *
     * @param  \SplititSdkClient\Model\PublicTokenRequest $request (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function installmentPlanCreatePublicTokenRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling installmentPlanCreatePublicToken'
            );
        }

        $resourcePath = '/api/InstallmentPlan/CreatePublicToken';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
