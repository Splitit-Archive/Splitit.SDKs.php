...
class LogoutApi
{
     ...
     *
     * @param  \SplititSdkClient\Model\LogoutRequest $request request (required)
     *
     * @throws \SplititSdkClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplititSdkClient\Model\LogoutResponse
     */
    public function logoutPost($request)
    {
        list($response) = $this->logoutPostWithHttpInfo($request);
        return $response;
    }
     ...
     *
     * @param  \SplititSdkClient\Model\LogoutRequest $request (required)
     *
     * @throws \SplititSdkClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplititSdkClient\Model\LogoutResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function logoutPostWithHttpInfo($request)
    {
        $returnType = '\SplititSdkClient\Model\LogoutResponse';
        $request = $this->logoutPostRequest($request);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SplititSdkClient\Model\LogoutResponse',
     ...
     */
    public function logoutPostAsync($request)
    {
        return $this->logoutPostAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function logoutPostAsyncWithHttpInfo($request)
    {
        $returnType = '\SplititSdkClient\Model\LogoutResponse';
        $request = $this->logoutPostRequest($request);
     ...
     */
    protected function logoutPostRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling logoutPost'
            );
        }
