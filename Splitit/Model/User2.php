...
class User2 implements ModelInterface, ArrayAccess
{
    ...
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 150)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling User2., must be smaller than or equal to 150.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling User2., must be bigger than or equal to 0.');
        }
    ...
    public function setUserName($user_name)
    {
        if (!is_null($user_name) && (mb_strlen($user_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling User2., must be smaller than or equal to 150.');
        }
        if (!is_null($user_name) && (mb_strlen($user_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling User2., must be bigger than or equal to 0.');
        }
    ...
    public function setUniqueId($unique_id)
    {
        if (!is_null($unique_id) && (mb_strlen($unique_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $unique_id when calling User2., must be smaller than or equal to 100.');
        }
        if (!is_null($unique_id) && (mb_strlen($unique_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unique_id when calling User2., must be bigger than or equal to 0.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 150)) {
            throw new \InvalidArgumentException('invalid length for $email when calling User2., must be smaller than or equal to 150.');
        }
        if (!is_null($email) && (mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling User2., must be bigger than or equal to 0.');
        }
